    ...
    <div className='container'>
      ...
      <div className='right-container'>
        ...
        <div className='welcome-portion'>
          ...
          <h3 className='sign-in-p'>Please sign in to access your account</h3>
        </div>
        ...
        <div className='button-portion'>
          ...
          <button className='google-sign-in-button'>
            ...
            <p className='google-sign-in-p'>Sign in with Google</p>
          </button>
          <p className='no-account-p'>Don't have an account? <span className='no-account-span'>Sign up</span></p>
        </div>
